defmodule RegisterRoomWeb.ParticipantControllerTest do
  use RegisterRoomWeb.ConnCase

  alias RegisterRoom.Registration

  @create_attrs %{email: "some email", firm: "some firm", name: "some name", position: "some position", surname: "some surname"}
  ...
  def fixture(:participant) do
    {:ok, participant} = Registration.create_participant(@create_attrs)
    participant
  end
